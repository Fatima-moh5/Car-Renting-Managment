        ...
        <div class="card-body">
            <div class="col-lg-6 ">
                <div class="btn-group w-100">
                      <a class="btn btn-success col fileinput-button" href="{{url('admin/make/create')}}">
...
{{--                        <td> <a type="button" href="{{url('admin/make/edit'.$make->id)}}" class="btn btn-block btn-secondary btn-sm">Edit</a></td>--}}
                    </tr>
                @endforeach
                </tbody>
                <tfoot>
